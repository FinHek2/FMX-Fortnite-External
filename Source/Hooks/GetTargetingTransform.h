...
float* CalculateShot(uintptr_t arg0, uintptr_t arg1, uintptr_t arg2)
{
	...
	if (Variables::GetTargetingTransform::bShouldStartAtLocationTarget)
	{
		...
		{
			ReturnValue[4] = Variables::GetTargetingTransform::LocationTarget.X - ActorLocation.X;
			ReturnValue[5] = Variables::GetTargetingTransform::LocationTarget.Y - ActorLocation.Y;
			ReturnValue[6] = Variables::GetTargetingTransform::LocationTarget.Z - ActorLocation.Z;
		}
	}
