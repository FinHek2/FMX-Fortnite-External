...
namespace Framework
{
	...
	public:
		...
		bool CreateMenu(FString title)
		{
			...
			Wrapper::Rect(this->Position, this->Size, FLinearColor(0.f, 0.f, 0.f, 1.f), 1.f);

			Render::box_rounded(this->Position, this->Size, FLinearColor(0.f, 0.f, 0.f, 1.f), 1.f, 38.0, 1.0);
	...
	void DrawMenu()
	{
		...
		Framework.CreateMenu(FString(L"FMX External"));
		...
		else if (MenuTab == 3)
		{
			...
			Framework.TextColored(FString(L"Copyright (C) Jesse ;) 2023-2025"), FLinearColor(0.f, 1.f, 1.f, 1.f));
		}
		else if (MenuTab == 4)
		{
			Framework.Space(0, 5);
			...
			Framework.Checkbox(FString(L"Teleport to waypoint"), &Settings::Exploits::PlayerTeleport);
