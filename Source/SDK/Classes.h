...
public:
	...
	{
		static UObject* Function = 0;
		if (!Function) Function = FindObject(L"Actor.WasRecentlyRendered");
...
public:
	...
	{
		return *(UFortWeaponItemDefinition**)(this + 0x498);
	}

	int AmmoCount()
	{
		return *(int*)(this + 0xd3c);
	}

	float LastFireAbilityTime()
	{
		return *(float*)(this + 0xffc);
	}
...
public:
	...
	{
		return *(AFortAthenaVehicle**)(this + 0x27f8);
	}
...
public:
	...
	{
		return *(TArray<USkeletalMeshComponent*>*)(this + 0x5af0);
	}

	TArray<UMaterialInstanceDynamic*> PawnMaterials_ALL()
	{
		return *(TArray<UMaterialInstanceDynamic*>*)(this + 0x5b00);
	}
};
...
public:
	...
	{
		return *(UGameInstance**)(this + 0x1B8);
	}
...
public:
	...
	static FString GetClassDisplayName(UObject* Class)
	{
		UObject* Function = 0;
		if (!Function) Function = FindObject(L"KismetSystemLibrary.GetClassDisplayName");
...
namespace Custom
{
	...
	FVector PredictProjectile(UWorld* World, FVector StartLocation, FVector ForwardVector, double Gravity, double InitialSpeed, double TimeStep, double SlideMultiplier = 1.0)
	{
		...
		bool bHit = UKismetSystemLibrary::LineTraceSingle(World, CurrentLocation, NextLocation, ETraceTypeQuery::TraceTypeQuery5, false, IgnoredActors, EDrawDebugTrace::ForDuration, HitResult, false);
		if (bHit)
		{
