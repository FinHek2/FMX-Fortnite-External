...
void DllStart()
{
    ...
    Variables::DebugCanvasObject = reinterpret_cast<UCanvas*>(UObject::FindObject(L"DebugCanvasObject", reinterpret_cast<UObject*>(-1)));
    ...
    {
        //ViewportHook.Insert(&DrawTransition, Offsets::DrawTransition, &DrawTransitionOriginal);
        ViewportHook.Insert(&PostRender, Offsets::PostRender, &PostRenderOriginal);
